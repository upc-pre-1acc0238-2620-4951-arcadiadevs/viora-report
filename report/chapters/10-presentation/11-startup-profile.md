...
\noindent \textbf{Significado del nombre y del símbolo}
...
```{=latex}
\noindent\colorbox{softrose}{\parbox{\dimexpr\textwidth-2\fboxsep\relax}{%
\vspace{0.25cm}
...
\begin{minipage}[c]{0.72\textwidth}
\raggedright
\hspace*{0.5in}Ser la plataforma AgTech de referencia en el sector olivarero, reconocida por convertir la alternancia productiva de una fatalidad asumida en una variable gestionable y medible, impulsando una agricultura más predecible, rentable y sostenible en el tiempo.
\end{minipage}
\vspace{0.25cm}
}}
```
...
\noindent\textbf{Li Gayoso, Diana Carolina (U202415749) - CMO \& UX Lead}
