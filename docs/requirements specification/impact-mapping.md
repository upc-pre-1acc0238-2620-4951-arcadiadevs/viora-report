...
flowchart TD
    ...
    D35["<b>Deliverable 3.4.1:</b> Mapa satelital y semáforo de riesgo"]
...
* 👤 ACTOR: Teodoro Mamani (Productor Olivarero)
  ...
  * 🔄 Impacto 3.2: Conoce el índice de alternancia de su predio y evalúa la acumulación de frío para anticipar anomalías fisiológicas.
    * 📦 Deliverable 3.2.1: Motor fisiológico de diagnóstico de vecería (BBI Hoblyn) y modelo dinámico de frío invernal (Erez / ENOS)
      * `US20`: Registro histórico plurianual de cosechas y cálculo del Índice Bienal de Vecería (BBI).
  ...
  * 🔄 Impacto 3.3: Realiza muestreos a pie de árbol sin conexión, regula la carga frutal en ventana fenológica oportuna y asienta la cosecha real para comprobar la estabilización interanual.
    * 📦 Deliverable 3.3.1: Asistente móvil offline de muestreo de cuajado y motor de prescripción de aclareo frutal
      ...
      * `US25`: Consulta e historial de árboles muestreados en campo.
    ...
    * 📦 Deliverable 3.3.2: Módulo de cierre de campaña y balance interanual de estabilización productiva
      * `US29`: Asentamiento de cosecha real de cierre de campaña y balance de estabilización productiva.

* 👤 ACTOR: Rubén Ticona (Gestor Técnico de Cooperativa)
  * 🔄 Impacto 3.4: Monitorea la distribución espacial de los predios socios y prioriza visitas técnicas en aquellos con sobrecarga o riesgo térmico.
    * 📦 Deliverable 3.4.1: Cartografía satelital interactiva de socios y tablero semafórico de vulnerabilidad
      * `US12`: Visualización cartográfica consolidada de socios agremiados.
      * `US31`: Semáforo fenológico de riesgo y sobrecarga de predios socios para el gestor técnico.
  * 🔄 Impacto 3.5: Proyecta tempranamente los volúmenes de acopio para comprometer ventas de exportación y dispone de documentación técnica auditable.
    * 📦 Deliverable 3.5.1: Motor predictivo de acopio discriminado y generador de Ficha Técnica PDF auditable
      * `US30`: Generación y exportación de ficha técnica y reporte agronómico de parcela en PDF.
...
| US08: Administración de cartera de socios y generación de códigos de invitación<br>Como Gestor Técnico de Cooperativa, quiero consultar los cupos corporativos contratados y generar códigos de activación únicos para los agricultores socios, para administrar formalmente la nómina de fundos agremiados y facilitar la incorporación técnica de los productores a la red de monitoreo y acopio. | Rubén Ticona | Digitaliza e incorpora masivamente a sus socios agremiados en una red comunitaria de asistencia técnica | Gestor corporativo de membresías y distribución de invitaciones | BG-01 |
...
| US25: Consulta e historial de árboles muestreados en campo<br>Como Productor Olivarero, quiero consultar el consolidado y el detalle de los árboles muestreados en mi parcela durante la campaña, para comprobar el grado de avance del recorrido de campo y verificar que la muestra vegetal sea representativa de todo el lote. | Teodoro Mamani | Realiza muestreos a pie de árbol sin conexión y regula la carga frutal en ventana fenológica oportuna | Asistente móvil offline de muestreo de cuajado y brotes | BG-03 |
...
| US29: Asentamiento de cosecha real de cierre de campaña y balance de estabilización productiva<br>Como Productor Olivarero, quiero asentar los kilogramos reales cosechados al finalizar la campaña agrícola y contrastarlos con las campañas previas, para comprobar numéricamente la reducción del índice de alternancia (BBI) y verificar la efectividad de las prácticas de aclareo en la mitigación de la vecería prolongada y el sostenimiento de un piso productivo en los años de menor cosecha. | Teodoro Mamani | Asienta la cosecha real al cierre de campaña para contrastar y verificar la estabilización interanual | Módulo de cierre de campaña y balance interanual de rendimiento | BG-03 |
| US12: Visualización georreferenciada de la cartera de predios socios en mapa satelital<br>Como Gestor Técnico de Cooperativa, quiero consultar un mapa satelital interactivo que geolocalice todas las parcelas de los socios junto con mi posición GPS en tiempo real, para organizar rutas eficientes de asistencia agronómica en campo y verificar la distribución espacial de los predios agremiados. | Rubén Ticona | Monitorea la distribución espacial de predios socios y prioriza visitas técnicas en predios vulnerables | Cartografía satelital interactiva multi-parcela de socios | BG-03 |
| US31: Semáforo fenológico de riesgo y sobrecarga de predios socios para el gestor técnico<br>Como Gestor Técnico de Cooperativa, quiero consultar un tablero con un semáforo de riesgo que clasifique las parcelas socias según su vulnerabilidad térmica y nivel de sobrecarga frutal, para priorizar las visitas técnicas de asistencia agronómica en los predios con mayor amenaza de vecería severa. | Rubén Ticona | Monitorea la distribución espacial de predios socios y prioriza visitas técnicas en predios vulnerables | Tablero semafórico de riesgo fenológico cooperativo | BG-03 |
| US30: Generación y exportación de ficha técnica y reporte agronómico de parcela en PDF<br>Como usuario de Viora (Productor Olivarero o Gestor Técnico), quiero exportar un reporte documental en formato PDF con la ficha técnica del lote, acumulado de frío, histórico de BBI y prescripciones de aclareo, para contar con documentación técnica auditable ante entidades financieras, cooperativas agrarias y certificadoras de calidad. | Rubén Ticona | Dispone de documentación técnica auditable ante entidades financieras y certificadoras de calidad | Generador de reportes documentales y Ficha Técnica PDF | BG-03 |
